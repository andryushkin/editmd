...
Плагин активируется при валидной конфигурации минимум из одного уникального односоставного marker. Кнопка-пазл добавляет минимальный одно-state шаблон; до добавления второго состояния клик остаётся в том же состоянии:
